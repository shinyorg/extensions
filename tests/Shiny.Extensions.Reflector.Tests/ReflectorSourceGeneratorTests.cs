...
using Shiny.Extensions.Reflector.SourceGenerators;
...
public class ReflectorSourceGeneratorTests
{
    ...
    GeneratorDriverRunResult Generate(string source, Dictionary<string, string>? analyzerConfigOptions = null)
    {
        ...
        // Create references including the Shiny.Extensions.Reflector assembly
        var references = new[]
        {
            MetadataReference.CreateFromFile(typeof(object).Assembly.Location), // System.Private.CoreLib
            MetadataReference.CreateFromFile(typeof(Attribute).Assembly.Location), // System.Runtime
            MetadataReference.CreateFromFile(typeof(ReflectorAttribute).Assembly.Location), // Shiny.Extensions.Reflector
