...
public static class __GeneratedRegistrations
{
    ...
    {
        services.AddSingleton<global::TestNamespace.IService>(sp => new global::TestNamespace.MyService(sp.GetRequiredKeyedService<global::TestNamespace.ICache>("primary")));
